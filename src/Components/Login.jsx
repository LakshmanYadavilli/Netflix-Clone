  ...
  return (
    <div className="w-screen h-screen">
      ...
      <form
        ...
        className="block absolute xs:w-2/4 sm:w-[40%] w-1/4 xs:mt-[28vh] sm:mt-[27vh] md:mt-[24vh] xs:h-[44vh] sm:h-[46vh] md:h-[52vh]  p-8 bg-black  mx-auto left-0 right-0 text-white bg-opacity-80"
      >
